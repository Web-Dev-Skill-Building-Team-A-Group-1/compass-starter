...
import { OnboardWeeklyGoalsComponent } from './onboard-weekly-goals.component';
...
describe('OnboardWeeklyGoalsComponent', () => {
  let component: OnboardWeeklyGoalsComponent;
  let fixture: ComponentFixture<OnboardWeeklyGoalsComponent>;
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(OnboardWeeklyGoalsComponent);
