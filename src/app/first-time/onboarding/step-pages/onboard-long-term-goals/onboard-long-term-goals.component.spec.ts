...
import { OnboardLongTermGoalsComponent } from './onboard-long-term-goals.component';
...
describe('OnboardLongTermGoalsComponent', () => {
  let component: OnboardLongTermGoalsComponent;
  let fixture: ComponentFixture<OnboardLongTermGoalsComponent>;

  beforeEach(waitForAsync(() => {
    TestBed.configureTestingModule({
      imports: [OnboardLongTermGoalsComponent],
      providers: [
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(OnboardLongTermGoalsComponent);
